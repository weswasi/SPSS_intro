...
Med hjälp av nedanstående flödesschema kan ni avgöra vilket test som lämpar sig bäst för de variabler som ni önskar att analysera. Observera att ett ytterligare
